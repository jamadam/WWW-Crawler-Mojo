...
is resolve_href($base, '/hoge.html'),
    'http://example.com/hoge.html', 'right url';
is resolve_href($base, './hoge.html'),
    'http://example.com/hoge.html', 'right url';
is resolve_href($base, '#a'),
    'http://example.com', 'right url';
...
is resolve_href($base, '/hoge.html'),
    'http://example.com/hoge.html', 'right url';
is resolve_href($base, '/'),
    'http://example.com/', 'right url';
is resolve_href($base, ''),
    'http://example.com/dir/', 'right url';
is resolve_href($base, 'foo'),
    'http://example.com/dir/foo', 'right url';
...
is resolve_href($base, '/'),
    'http://example.com/', 'right url';
is resolve_href($base, ''),
    'http://example.com/dir/org', 'right url';
is resolve_href($base, 'foo'),
    'http://example.com/dir/foo', 'right url';
